...
export default async function HomeHero({
  ...
  `{
    ...
    // all published, regardless of filters
    "publishedTotal": count(*[
      _type == "post" &&
      lower(status) == "published"
    ])
  }`,
  { filterRegionIds, start, end, sort }
)
...
{/* Community banner (scoped, renamed classes) */}
...
HESI is chaired by the United Nations Department of Economic and Social Affairs (UN DESA), UN University, UNESCO International Institute for Higher Education in Latin America and the Caribbean (IESALC), and the Sulitest Association.
Other UN partners include UNESCO, UN Environment Programme, UN Global Compact’s Principles for Responsible Management Education initiative, UN-HABITAT, UNCTAD, UNITAR, UN Office for Partnerships, and UN Academic Impact.
<p></p>
...
<p className="hesi-cta">
  ...
  >
    ...
    >
      {/* Feather-style external link icon */}
...
<p></p>
    ...
    <div className="homehero-layout">
      {/* LEFT: counter, sort, active chips, regions */}
